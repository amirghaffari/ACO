...
start_aco (Fname, Vertex_degree, Duplicating, Num_Ants, Iter_Global, Iter_Local, NodeFile, Params0, Recovery) ->
	...
	[Head|_Tail]=Nodes,
	MasterPID=spawn_link(Head, ant_master, run, [Num_Jobs, Vertex_degree, Duplicating, Num_Ants, Iter_Global, Iter_Local, Inputs, Params, Nodes, Recovery]),
...
run2(Args,Params) ->
	...
	[Fname,Vertex_degree0, Duplicating0, Num_Ants0, Iter_Global0, Iter_Local0, NodeFile] ->
		...
		timer:tc (fun() -> start_aco (Fname, Vertex_degree, Duplicating, Num_Ants, Iter_Global, Iter_Local, NodeFile, Params, _Recovery=false) end),
